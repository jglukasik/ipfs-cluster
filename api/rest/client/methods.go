...
func WaitFor(ctx context.Context, c ClientIface, fp StatusFilterParams) (api.GlobalPinInfo, error) {
...
func (sf *statusFilter) pollStatus(ctx context.Context, c ClientIface, fp StatusFilterParams) {
